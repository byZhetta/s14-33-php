        ...
        <section className=' space-y-4 pb-6'>
            ...
            <div className="carousel carousel-center space-x-6 w-full flex items-center">
                <div className="carousel-item">
                    <div className="card card-compact w-56 bg-color1 dark:bg-color4 lg:w-72 xl:w-80">
                        ...
                        <div className="card-body">
                            ...
                            <p className=' text-xs lg:text-sm text-white dark:text-black '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore accusamus fuga necessitatibus eligendi ea tempora id sint molestias soluta excepturi quo commodi, cum laboriosam praesentium sit magni esse, ex repellat!</p>
