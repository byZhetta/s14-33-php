...
const Card = () => {
  return (
    <section className="flex justify-center mt-12">
      <h1 className="mt-[-50px] text-xl text-white font-bold mr-40">Intensidad</h1>
      <button>
      ...
      <button>
      <div className="card card-compact w-[293px] h-[194px] bg-gradient-to-b from-[#1100CF] to-[#9308E8] shadow-xl mr-3">
